...
export function WorkoutDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Link
        to={ROUTES.WORKOUTS}
        className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#71717A] hover:text-white"
      >
      ...
      <div>
        ...
        <div className="flex items-center gap-4 text-xs font-semibold text-[#71717A] mt-2">
      ...
      <div className="relative aspect-video w-full rounded-xl overflow-hidden bg-[#1A1A1F]">
        <img
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <Button size="lg" className="rounded-full h-16 w-16 p-0 font-black shadow-lg">
